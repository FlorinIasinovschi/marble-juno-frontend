...
export const NFTSell = ({ collectionId, id }) => {
  ...
  const startSale = async (e) => {
    ...
    let duration_type: DurationType = {
      startTime: Math.round(duration[0].getTime() / 1000),
      endTime: Math.round(duration[1].getTime() / 1000),
    };
    const marketContract = Market(PUBLIC_MARKETPLACE).use(client);
      ...
      {nft.name != "" && royalties && (
        <Nft className="nft-info">
          <NftInfoTag className="nft-detail">
            ...
            {sellType == SALE_TYPE[0] && (
              <>
                  ...
                  <DropDownContainer>
                    <DropDownHeader onClick={togglingPrice}>
                      <Image
                        ...
                        src={paymentTokens[priceSelectedOption].logoUri}
                      />
                      {paymentTokens[priceSelectedOption].name}
                      <ArrowDown />
                    </DropDownHeader>
                    {isPriceOpen && (
                      <DropDownListContainer>
                        <DropDownList>
                          {paymentTokens.map((token, idx) => (
                            <ListItem
                              onClick={onPriceOptionClicked(idx)}
                              key={`price${idx}`}
                            >
                              <Image
                                alt="Token Icon"
                ...
                <PriceFooterContainer>
                  <NftDollarPrice
                    symbol={paymentTokens[priceSelectedOption].symbol}
                    amount={price}
                  />
                </PriceFooterContainer>
              </>
            ...
            {sellType == SALE_TYPE[1] && (
              <>
                  ...
                  <DropDownContainer>
                    <DropDownHeader onClick={togglingSellingPrice}>
                      <Image
                        alt="Token Icon"
                        className="token-icon"
                        src={paymentTokens[sellingPriceSelectedOption].logoUri}
                      />
                      {paymentTokens[sellingPriceSelectedOption].name}
                      <ArrowDown />
                    </DropDownHeader>
                    {isSellingPriceOpen && (
                      <DropDownListContainer>
                        <DropDownList>
                          {paymentTokens.map((token, idx) => (
                            <ListItem
                              onClick={onSellingPriceOptionClicked(idx)}
                              key={`sellingprice${idx}`}
                            >
                              <Image
                                alt="Token Icon"
                                className="token-icon"
                ...
                <PriceFooterContainer>
                  <NftDollarPrice
                    symbol={paymentTokens[sellingPriceSelectedOption].symbol}
                    amount={sellingPrice}
                  />
                </PriceFooterContainer>
              </>
            ...
            {sellType == SALE_TYPE[1] && (
              <ReserveContainer>
                ...
                <PriceContainer
                  className={`${isReserverPrice ? "mb0" : "hide"}`}
                >
                  <DropDownContainer>
                    <DropDownHeader onClick={togglingReserverPrice}>
                      <Image
                        alt="Token Icon"
                        className="token-icon"
                        src={paymentTokens[reserverPriceSelectedOption].logoUri}
                      />
                      {paymentTokens[reserverPriceSelectedOption].name}
                      <ArrowDown />
                    </DropDownHeader>
                    {isReserverPriceOpen && (
                      <DropDownListContainer>
                        <DropDownList>
                          {paymentTokens.map((token, idx) => (
                            <ListItem
                              onClick={onReserverPriceOptionClicked(idx)}
                              key={`reserverprice${idx}`}
                            >
                              <Image
                                alt="Token Icon"
                                className="token-icon"
                  ...
                  <Input
                    ...
                    placeholder=""
                    value={reserverPrice}
                    onChange={handleReserverPriceChange}
                  />
                </PriceContainer>
                <PriceFooterContainer className="between">
                  ...
                  <span>
                    <NftDollarPrice
                      symbol={paymentTokens[reserverPriceSelectedOption].symbol}
                      amount={reserverPrice}
                    />
                  </span>
                </PriceFooterContainer>
              </ReserveContainer>
          ...
          <NftUriTag className="sell-nft-uri">
            ...
            {nft.type == "image" && <Image src={nft.image} alt="NFT Image" />}
            {nft.type == "video" && (
              <video controls>
