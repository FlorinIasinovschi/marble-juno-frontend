        ...
        <StyledDivForMint className="mint-section">
          <StyledDivForMint className="mint-action">
            <Text variant="primary" css={{ paddingBottom: "$4" }}>
              ...
              of marble with DAO, rewards and airdrop for owners. Each NFT
              provides the membership to exclusive contents and incentives.
            </Text>
            ...
            <StyledCreator>Created by: The Sculptor</StyledCreator>
            <NFTStatus
              totalNFTs={maxToken}
              royalties={royalties}
