...
export function NftPrice({ nft }: NftCardProps): JSX.Element {
  ...
  return (
    <>
      {nft.sale.hasOwnProperty("sale_type") &&
        nft.sale.sale_type == SALE_TYPE[0] && (
          <>
              ...
              <>
                ...
                <PriceDiv className="price-section">
                  ...
                  <span className="token-balance">
                    {nft.price}&nbsp;{nft.paymentToken.symbol}
                  </span>
              ...
              <>
                ...
                <PriceDiv className="price-section">
                  ...
                  <span className="token-balance">
                    {getRealTokenAmount({
                      amount:
                        nft.sale.requests[nft.sale.requests.length - 1].price,
                  ...
                  <span className="nft-price">
                    (
                    <NftDollarPrice
                      symbol={nft.paymentToken.symbol}
                      amount={getRealTokenAmount({
                        amount:
                          nft.sale.requests[nft.sale.requests.length - 1].price,
                        denom: nft.paymentToken.denom,
                      })}
